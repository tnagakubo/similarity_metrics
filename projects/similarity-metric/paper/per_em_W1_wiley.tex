...
% structural question; (iii) subsection 3.1.4 of the outline (procedure
% justification, anchor-vs-clustering, 100k reps) -- its content currently lives
% in the Discussion paragraph sourced from results/anchor_vs_clustering_tau_100k.csv,
% and moving or duplicating it is a Tak decision.
...
% TODO (2026-08-30): queued review edit (decision 4, 2026-08-15) -- item (i)
% below cites S5/S6 (Study 1), but the structural-blindness evidence now lives
% in Study 2 (sec:study2_classification), and Study 1's SMD table was deleted
% in the 2026-08-30 restructure. Re-point during the paragraph review.
...
% TODO (2026-08-30): queued review edit (decision 4, 2026-08-15) -- "The $W_1$
% distance addresses all three" below needs the controlled reading (location-
% dominated data; see sec:app_allmethods), and the S5/S6 sentence cites the
% deleted Study 1 SMD table (evidence now in sec:study2_classification).
% Re-point during the paragraph review.
