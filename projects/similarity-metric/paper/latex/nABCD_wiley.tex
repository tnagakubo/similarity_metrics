...
\begin{enumerate}[1.]
\item \textbf{Bias}: Less than 0.02 for non-null scenarios at $n \geq 100$, excluding S05 where persistent bias of $-0.04$ reflects boundary effects at large true values
\item \textbf{Coverage}: 0.87--0.98 at $n \geq 100$ for most scenarios
\item \textbf{Precision}: RMSE below 0.06 and CI width below 0.18 at $n \geq 100$
