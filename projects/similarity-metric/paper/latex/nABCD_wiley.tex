...
\end{tabular*}
\begin{tablenotes}
\item Bias is defined as $\text{Mean}(\widehat{\text{nABCD}}) - \text{true nABCD}$. Results based on 500 replications with $B = 2{,}000$ bootstrap resamples.
\end{tablenotes}
\end{table}
...
\end{tabular*}
\begin{tablenotes}
\item CI width is defined as mean of (upper $-$ lower) across 500 replications.
\end{tablenotes}
\end{table}
