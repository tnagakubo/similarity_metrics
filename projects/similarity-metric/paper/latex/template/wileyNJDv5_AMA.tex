...
pellentesque felis eu massa. Example for bibliography citation \cite{Taylor1937}, text \cite{Knupp1999,Kamm2000} inserted in text for your reference.
...
venenatis arcu wisi vel nisl. Vestibulum diam. (Figure \ref{fig1} and \ref{fig2}) Aliquam pellentesque, augue quis sagittis posuere, turpis lacus congues
