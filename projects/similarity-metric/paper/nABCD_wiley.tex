...
Table~\ref{tab:bias} presents the bias of the nABCD estimator across scenarios and sample sizes. The estimator showed positive bias under the null hypothesis (S1), with bias decreasing from 0.093 at $n=50$ to 0.047 at $n=200$. This positive bias arises because the non-negativity constraint inherited from the Wasserstein distance yields $\widehat{\text{nABCD}} > 0$ with probability 1 in finite samples, even when the true value equals zero ($F_1 = F_2$ almost everywhere). The estimator remains consistent ($\widehat{\text{nABCD}} \to 0$ as $n \to \infty$), but the convergence is slow near the parameter space boundary.
...
Scenario S3 (0.5$\sigma$ location shift, true nABCD $= 0.180$) exemplifies the operating characteristics at clinically relevant effect sizes. Bias was negligible ($+0.003$ at $n = 100$), coverage was nominal (0.951), and CI width (0.18) translated to a $\Delta_{\max}$ CI width of $0.01 \times 17 \times 0.18 = 0.061$ (6.1\%pt) when calibrated with $L = 0.01$/yr and IQR $= 17$ (age-scale parameters representative of the GUSTO-I application)---a level of precision sufficient for informed regulatory deliberation.
...
\midrule
R1  & 0.018 & 0.058 & 0.0155 & 0.0028 & \checkmark & \checkmark & \checkmark \\
R2  & 0.061 & 0.015 & 0.0047 & 0.0105 & --- & \checkmark & --- \\
R3  & 0.076 & 0.051 & 0.0038 & 0.0030 & --- & \checkmark & --- \\
R4  & 0.016 & 0.042 & 0.0180 & 0.0038 & \checkmark & \checkmark & \checkmark \\
R5  & 0.011 & 0.056 & 0.0256 & 0.0030 & \checkmark & \checkmark & \checkmark \\
R6  & 0.026 & 0.050 & 0.0110 & 0.0030 & \checkmark & \checkmark & \checkmark \\
R7  & 0.011 & 0.082 & 0.0247 & 0.0020 & \checkmark & --- & --- \\
R9  & 0.017 & 0.110 & 0.0171 & 0.0015 & \checkmark & --- & --- \\
R10 & 0.038 & 0.062 & 0.0072 & 0.0025 & --- & \checkmark & --- \\
R11 & 0.035 & 0.104 & 0.0079 & 0.0016 & --- & --- & --- \\
R12 & 0.024 & 0.097 & 0.0116 & 0.0016 & \checkmark & --- & --- \\
R13 & 0.034 & 0.037 & 0.0087 & 0.0042 & --- & \checkmark & --- \\
R14 & 0.020 & 0.064 & 0.0142 & 0.0023 & \checkmark & \checkmark & \checkmark \\
R15 & 0.017 & 0.074 & 0.0164 & 0.0021 & \checkmark & \checkmark & \checkmark \\
R16 & 0.050 & 0.071 & 0.0057 & 0.0023 & --- & \checkmark & --- \\
\bottomrule
\end{tabular}
\begin{tablenotes}
...
Among the jointly eligible partners, R4 emerges as the leading single-pool candidate. R4 ranks 3rd-lowest on age (0.016) and 4th-lowest on SBP (0.042), balanced across both modifiers. R5 has the lowest age nABCD (0.011) but the 6th-lowest SBP nABCD (0.056), an asymmetric profile. The framework supplies the quantitative inputs (nABCD with bootstrap CIs in Table~\ref{tab:gusto_nabcd}, partner-specific $L^*$ in Table~\ref{tab:gusto_lstar_joint}, and joint eligibility under the assumed bounds) to support sponsor judgment in consultation with clinical and regulatory advisors. Note that the GUSTO-I data were collected during 1990--1993; the application here serves as methodological illustration using publicly available IPD, not as an endorsement of these specific distributions for contemporary thrombolytic-trial planning.
