...
✅ **All three resolved.** ~~(a) the ρ/ρ_trans regime heuristic~~ and ~~(b) the oracle-best-threshold steelman + Part 1B~~ → **decided 2026-09-05 (Tak): NOT written — deleted from the plan** (the `.tex` TODOs are replaced by decision notes); (c) ~~§3.1.4 placement~~ → ✅ **decided 2026-08-30 (Tak, option A): stays in the Discussion; §3.1.4 not written**.
